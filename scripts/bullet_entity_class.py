...
from scripts.explosion_class import Explosion
...
class BulletEntity:
    def __init__(self, entity, displacement: int):
        self.image = pygame.image.load('bullet/entity_bullet1.png').convert_alpha()
...
class BulletEntityTwo(BulletEntity):
    def __init__(self, entity, displacement: int):
        ...
        self.image = pygame.image.load('bullet/entity_bullet2.png').convert_alpha()
        self.width = self.image.get_width()
        self.height = self.image.get_height()
        self.id = 2
        self.speed = 2.5
...
class BulletEntityThree(BulletEntity):
    def __init__(self, entity, displacement: int):
        super().__init__(entity, displacement)
        self.image = pygame.image.load('bullet/entity_bullet3.png').convert_alpha()
        self.width = self.image.get_width()
        self.height = self.image.get_height()
        self.id = 3
        self.speed = 1
