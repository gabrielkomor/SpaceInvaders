...
from scripts.bullet_entity_class import *
...
class Entity:
    ...
    def __init__(self, x_cord: int, y_cord: int):
        self.image = [pygame.image.load(f'entity1/ufo_{x}_7.png').convert_alpha() for x in range(0, 8)]
        self.health_image = pygame.image.load('entity1/loading_bar_1_2.png').convert_alpha()
        self.x_cord = x_cord
        self.y_cord = y_cord
        self.draw_speed = 0.1
        self.counter = 0
...
class EntityTwo(Entity):
    def __init__(self, x_cord: int, y_cord: int):
        ...
        self.image = [pygame.image.load(f'entity2/ufo2_{x}_7.png').convert_alpha() for x in range(0, 8)]
        self.health_image_low = pygame.image.load('entity2/health_bar_0_1.png').convert_alpha()
        self.health_image_choose = self.health_image_medium = (pygame.image.load('entity2/health_bar_1_1.png').
                                                               convert_alpha())
        self.draw_speed = 0.1
        self.counter = 0
...
class EntityThree(Entity):
    def __init__(self, x_cord: int, y_cord: int):
        super().__init__(x_cord, y_cord)
        self.image = [pygame.image.load(f'entity3/ufo3_{x}_7.png').convert_alpha() for x in range(0, 8)]
        self.health_image = [pygame.image.load(f'entity3/health_{x}_2.png').convert_alpha() for x in range(0, 3)]
...
class Boss:
    def __init__(self):
        self.image = [pygame.image.load(f'boss/boss_{x}.png').convert_alpha() for x in range(0, 6)]
        self.health_image = [pygame.image.load(f'boss/boss_health_{x}.png').convert_alpha() for x in range(0, 18)]
        self.x_cord = 300
        self.y_cord = 100
