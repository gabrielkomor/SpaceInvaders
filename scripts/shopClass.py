...
class Shop:
    ...
    def shop() -> None:
        ...
        add_bullet_speed = pygame.image.load('shopIcons/addBulletSpeed.png').convert_alpha()
        add_player_health = pygame.image.load('shopIcons/addHealth.png').convert_alpha()
        add_reload_speed = pygame.image.load('shopIcons/addReloadSpeed.png').convert_alpha()
        add_player_speed = pygame.image.load('shopIcons/addSpeed.png').convert_alpha()
        gear_image = pygame.image.load('shopIcons/gear.png').convert_alpha()
        cash_icon = pygame.image.load('shopIcons/dollar.png').convert_alpha()
        no_icon = pygame.image.load('shopIcons/no.png').convert_alpha()
        yes_icon = pygame.image.load('shopIcons/yes.png').convert_alpha()
        exit_icon = pygame.image.load('shopIcons/door.png').convert_alpha()
        player_level_1 = pygame.image.load('player/level_1/rocketStatic_1_Lvl_1.png').convert_alpha()
        player_level_2 = pygame.image.load('player/level_2/rocketStatic_1_Lvl_2.png').convert_alpha()
        player_level_3 = pygame.image.load('player/level_3/rocketStatic_1_Lvl_3.png').convert_alpha()
        player_level_4 = pygame.image.load('player/level_4/rocketStatic_1_Lvl_4.png').convert_alpha()
